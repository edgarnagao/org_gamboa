...
Public Class mySqlDB
    ...
    'MySQL
    Public connString As String = "Server=127.0.0.1;Database=gamboadb;Uid=root;Pwd=593274;"
    ...
    Public Sub CreateConfirmBox(ByRef btn As WebControls.GridView,
                                       ByVal strMessage As String)
        btn.Attributes.Add("onclick", "return confirm('" & strMessage & "');")
    End Sub

    Public Sub CreateConfirmBoxButton(ByRef btn As WebControls.Button,
                                       ByVal strMessage As String)
        btn.Attributes.Add("onclick", "return confirm('" & strMessage & "');")
    End Sub

    Public Sub CreateConfirmBoxlink(ByRef btn As WebControls.LinkButton,
                                      ByVal strMessage As String)
        btn.Attributes.Add("onclick", "return confirm('" & strMessage & "');")
    End Sub
